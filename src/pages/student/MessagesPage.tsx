...
import { Send, Search, Building2, UserCircle } from 'lucide-react';
    ...
    <div className="flex flex-col" style={{ height: 'calc(100vh - 9rem)' }}>
      ...
      <div className="mb-4 shrink-0">
        ...
        <p className="text-slate-500 dark:text-slate-400 mt-1 flex items-center gap-2 text-sm">
          ...
          Connect with Staff within your branch and Global Admins.
        </p>
      </div>
      ...
      <div className="flex flex-1 min-h-0 overflow-hidden border border-slate-200 dark:border-slate-800 rounded-xl bg-white shadow-sm dark:bg-slate-950">
        ...
        <div className="w-72 shrink-0 border-r border-slate-200 dark:border-slate-800 flex flex-col bg-slate-50/50 dark:bg-slate-900/10">
          ...
          <div className="p-3 border-b border-slate-200 dark:border-slate-800 space-y-2">
            ...
            <Button className="w-full text-xs h-8 bg-blue-100 text-blue-700 hover:bg-blue-200 border-none shadow-none dark:bg-blue-900/30 dark:text-blue-300">
              <UserCircle className="w-3 h-3 mr-1" /> New Message
            </Button>
          </div>
              ...
              {filteredChats.map(chat => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className={`text-xs truncate mt-0.5 ${chat.unread ? 'font-medium text-slate-900 dark:text-slate-300' : 'text-slate-500 dark:text-slate-400'}`}>
                      {chat.lastMessage}
                    </p>
                  </div>
        ...
        <div className="flex-1 min-w-0 flex flex-col bg-white dark:bg-slate-950">
          {/* Chat Header */}
          <div className="h-14 border-b border-slate-200 dark:border-slate-800 flex items-center pl-8 pr-5 shrink-0 bg-white/50 backdrop-blur-sm dark:bg-slate-950/50">
            <div className="flex items-center gap-3 min-w-0">
              ...
              <div className="min-w-0">
                ...
                <p className="text-[11px] text-slate-500 font-medium tracking-wide truncate">{activeChat.role}</p>
              </div>
            </div>
          </div>

          {/* Messages Area */}
          <ScrollArea className="flex-1 pl-8 pr-5 py-4">
          ...
          <div className="pl-8 pr-4 py-4 border-t border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 shrink-0">
            <div className="flex gap-2">
              <Input
                placeholder="Type your message to staff/admin..."
                className="flex-1 bg-slate-50 dark:bg-slate-900 border-slate-200"
                value={replyText}
              ...
              />
              <Button onClick={handleSendMessage} size="icon" className="bg-blue-600 hover:bg-blue-700 shrink-0 shadow-md shadow-blue-600/20">
